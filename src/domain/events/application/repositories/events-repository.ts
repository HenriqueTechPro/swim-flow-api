...
import type {
  CreateEventRequest,
  UpdateEventRequest,
} from '../dtos/event-requests';
import type {
  PaginatedResult,
  PaginationParams,
} from '@/domain/shared/pagination/pagination-params';

export type CreateEventRepositoryInput = CreateEventRequest;
export type UpdateEventRepositoryInput = UpdateEventRequest;
...
export abstract class EventsRepository {
  abstract list(
    params?: ListEventsRepositoryParams,
